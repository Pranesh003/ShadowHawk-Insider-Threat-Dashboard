...
export const EventIcon: React.FC<EventIconProps> = ({ type }) => {
    ...
    switch (type) {
        ...
        case EventType.PROCESS:
            return <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>;
        case EventType.USB:
            return <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 5v14a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2z" /><path d="M10 17v-4h4v4m-4-6h4" /></svg>;
        case EventType.NETWORK:
            return <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.905 11A9 9 0 0112 5.065 9 9 0 0116.095 11M12 21v-5.935" /></svg>;
        ...
        default:
            // FIX: Replaced malformed SVG with a generic question mark icon to fix compilation error.
